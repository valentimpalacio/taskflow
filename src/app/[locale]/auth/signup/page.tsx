  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-primary-50/30 to-slate-50 dark:from-slate-900 dark:via-primary-950/20 dark:to-slate-900 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-emerald-200/30 dark:bg-emerald-800/10 blur-3xl particle-float-2" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-primary-300/20 dark:bg-primary-700/10 blur-3xl particle-float-1" />
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1.5">{t('signupSubtitle')}</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-slate-200/60 dark:border-slate-700/50 p-7 shadow-xl shadow-slate-200/50 dark:shadow-black/20 space-y-4">
          <div>
          ...
          {success && (
            <div className="flex items-center gap-2 text-sm text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/50 rounded-xl px-4 py-3 border border-emerald-100 dark:border-emerald-800/30">
